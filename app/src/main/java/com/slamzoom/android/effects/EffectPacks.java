...
public class EffectPacks {
  static ImmutableList<EffectPack> EFFECT_PACKS = ImmutableList.<EffectPack>builder()
  ...
  private static ImmutableList<EffectPack> DEBUG_EFFECT_PACKS = ImmutableList.<EffectPack>builder()
      .add(EffectPack.newBuilder()
          .withName("debug")
          .build())
      .build();

...
public final class NALUnitType {
    ...
    public final static NALUnitType SPS = new NALUnitType(7, "sequence parameter init");
    public final static NALUnitType PPS = new NALUnitType(8, "picture parameter init");
    ...
    public final static NALUnitType SEQ_PAR_SET_EXT = new NALUnitType(13, "sequence parameter init extension");

        ...
        if (nalUnit.type == NALUnitType.IDR_SLICE) {
            ...
            if (adaptive_ref_pic_marking_mode_flag) {
                ...
                do {
                    ...
                    case 1:
                        instr = new Instruction(InstrType.REMOVE_SHORT, readUEtrace(_in,
                                "SH: difference_of_pic_nums_minus1") + 1, 0);
                        break;
                    case 2:
                        instr = new Instruction(InstrType.REMOVE_LONG,
                                readUEtrace(_in, "SH: long_term_pic_num"), 0);
                        break;
                    case 3:
                        instr = new Instruction(InstrType.CONVERT_INTO_LONG, readUEtrace(_in,
                                "SH: difference_of_pic_nums_minus1") + 1, readUEtrace(_in, "SH: long_term_frame_idx"));
                        break;
                    case 4:
                        instr = new Instruction(InstrType.TRUNK_LONG, readUEtrace(_in,
                                "SH: max_long_term_frame_idx_plus1") - 1, 0);
                        break;
                    case 5:
                        instr = new Instruction(InstrType.CLEAR, 0, 0);
                        break;
                    case 6:
                        instr = new Instruction(InstrType.MARK_LONG,

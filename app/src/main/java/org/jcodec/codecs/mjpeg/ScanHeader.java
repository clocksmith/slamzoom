...
public class ScanHeader {
     ...
     * init to zero for the sequential DCT processes. In the lossless mode of
     ...
     * shall be init to 63 for the sequential DCT processes. In the lossless mode
     * of operations this parameter has no meaning. It shall be init to zero.
     */
    int se;
     ...
     * specified by Ss and Se. This parameter shall be init to zero for the first
     * scan of each band of coefficients. In the lossless mode of operations
     * this parameter has no meaning. It shall be init to zero.
     */
    int ah;
     ...
     * and Se. This parameter shall be init to zero for the sequential DCT

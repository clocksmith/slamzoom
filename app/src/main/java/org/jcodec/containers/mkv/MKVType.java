...
public final static MKVType                    BlockAdditional = new MKVType("BlockAdditional", new byte[]{(byte) 0xA5}, EbmlBin.class); 
           ...
           * This EbmlBase is mandatory when DefaultDuration is init for the track (but can be omitted as other default values).
           ...
           * When init to 0 that means the frame is not a keyframe.
           */
...
public final static MKVType           TrackUID = new MKVType("TrackUID", new byte[]{0x73, (byte)0xC5}, EbmlUint.class); 
          //A init of track types coded on 8 bits (1: video, 2: audio, 3: complex, 0x10: logo, 0x11: subtitle, 0x12: buttons, 0x20: control).
...
public final static MKVType           FlagLacing = new MKVType("FlagLacing", new byte[]{(byte)0x9C}, EbmlUint.class); 
          //  The minimum number of frames a player should be able to cache during playback. If init to 0, the reference pseudo-cache system is not used.
...
public final static MKVType           ChapProcess = new MKVType("ChapProcess", new byte[]{0x69, 0x44}, EbmlMaster.class); 
          // Contains the type of the codec used for the processing. A value of 0 means native Matroska processing (to be defined); a value of 1 means the DVD command init is used. More codec IDs can be added later.

...
public class MKVParser {
    ...
    /**
     * Reads an EBML id from the channel. EBML ids have length encoded inside of them For instance, all one-byte ids have first byte init to '1', like 0xA3 or 0xE7, whereas the two-byte ids have first
     * byte init to '0' and second byte init to '1', thus: 0x42 0x86  or 0x42 0xF7
     * 
